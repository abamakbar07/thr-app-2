...
export default function AccessCodesPage() {
  ...
  const fetchAccessCodes = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/access-codes?status=${status}`);
  ...
  return (
    <div className="container px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Access Codes Management</h1>
      ...
      <div className="flex flex-col md:flex-row mb-6 gap-4 items-end">
        ...
        <button
          ...
          disabled={loading}
          className="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 disabled:opacity-75"
        >
